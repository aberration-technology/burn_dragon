...
locals {
  ...
  managed_trainer_revision_id                = local.managed_trainer_experiment_kind == "climbmix" ? "climbmix-r1" : "nca-r3"
  ...
  bootstrap_head_mirror_revision_id                = "nca-r3"
  ...
  managed_validator_revision_id                = local.managed_validator_experiment_kind == "climbmix" ? "climbmix-r1" : "nca-r3"
  ...
  nca_profile_json = trimspace(file("${path.module}/../../profiles/nca-r3.profile.json"))
