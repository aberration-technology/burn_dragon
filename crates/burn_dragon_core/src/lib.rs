...
pub use model::{
    ...
    DragonPredictiveCodingSupport, DragonProjectionRole, DragonRandomScaffoldConfig,
    DragonRandomScaffoldReport, DragonReservoirInitializationConfig, DragonResidualScalingConfig,
    DragonResidualScalingKind, DragonTopologyPriorConfig, DragonTopologyPriorKind,
    ...
    MicroTransformerBlock, ModelState, NextLatentTransitionConfig, ResidualConnectorKind,
    SequenceKernelConfig, SequenceMemorySystem, SequenceScoreHeadConfig, SequenceTrainingExecutor,
    ...
    SharedLowrankPopulationWeights, SharedLowrankWeights, SummaryMemoryConfig,
    YNeuronRecurrenceConfig, build_dragon_random_scaffold_manifest, gated_deltanet2_reference,
