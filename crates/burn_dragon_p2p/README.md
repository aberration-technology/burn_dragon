...
```bash
# CPU
cargo install --locked burn_dragon_p2p --version 0.21.0-pre.28 --bin burn_dragon_p2p_native --no-default-features --features native

# WGPU
cargo install --locked burn_dragon_p2p --version 0.21.0-pre.28 --bin burn_dragon_p2p_native --features native,wgpu
