...
locals {
  ...
  managed_trainer_revision_id                = local.managed_trainer_experiment_kind == "climbmix" ? "climbmix-r1" : "nca-r4"
  ...
  bootstrap_head_mirror_revision_id                = "nca-r4"
  ...
  managed_validator_revision_id                = local.managed_validator_experiment_kind == "climbmix" ? "climbmix-r1" : "nca-r4"
  ...
  nca_profile_json = trimspace(file("${path.module}/../../profiles/nca-r4.profile.json"))
