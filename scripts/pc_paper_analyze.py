...
def write_markdown(
    ...
    lines.append("")
    lines.append(
        "| Matrix | Backend | Profile | Iters | Batch | Ckpt | Policy probe | Feedback | Policy mode | Arm | Runs | Seeds | Cold valid | Cold supervised tokens | Stream warm | Validation objective | Best objective | Final-best | Regression | Val slope | Source cadence | Free verifier acc | Action top-1 | Decode gap | Action NLL | Context swap | Counterfactual gain | Policy solve | Goal completion | Valid action | Partial progress | Wall tok/s | Model tok/s | Duty | PC ms |"
    )
    lines.append(
        "| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |"
    )
    for row in summary_rows:
        lines.append(
            "| {matrix} | {backend} | {profile} | {iters} | {batch_size} | {checkpoint_interval} | {policy_probe_cadence} | {source_feedback} | {policy_mode} | {arm} | {runs} | {seeds} | {valid} | {cold_tokens} | {warm} | {objective} | {best_objective} | {final_minus_best} | {regression} | {slope} | {source} | {verifier} | {action_top1} | {decode_gap} | {action_nll} | {context_swap} | {counterfactual_gain} | {policy_solve} | {goal_completion} | {valid_action} | {partial} | {tok} | {model_tok} | {duty} | {pc} |".format(
